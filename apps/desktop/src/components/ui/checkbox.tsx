...
function Checkbox({
  ...
  return (
    ...
    >
      ...
      >
        {/*
          A partial selection is not a selection, so it does not get a tick.
          Radix already reports it as `aria-checked="mixed"`; drawing the same
          check for both states would tell the eye something the accessibility
          tree contradicts.
        */}
